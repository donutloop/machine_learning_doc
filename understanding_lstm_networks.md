...
![](images/RNN-shorttermdepdencies.png)
...
It's now time to update the old cell state, \\(C_{t-1}\\), into the new cell
...
A slightly more dramatic variation on the LSTM is the Gated Recurrent Unit, or
